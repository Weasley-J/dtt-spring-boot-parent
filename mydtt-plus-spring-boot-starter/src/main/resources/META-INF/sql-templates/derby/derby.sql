...
-- assign an identity column attribute to an INTEGER column, and also define a primary key constraint on the column
CREATE TABLE PEOPLE
(
...
-- assign an identity column attribute to a SMALLINT column with an initial value of 5 and an increment value of 5 and with cycle option.
CREATE TABLE GROUPS
(
