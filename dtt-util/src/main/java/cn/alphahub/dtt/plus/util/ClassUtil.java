...
import cn.alphahub.dtt.plus.util.constant.Constants;
...
public final class ClassUtil {
    ...
    public static <T> T invoke(Method method, Class<T> aClass) {
        method.setAccessible(true);
        try {
            method.setAccessible(true);
            Constructor<T> constructor = aClass.getDeclaredConstructor();
            constructor.setAccessible(true);
            return (T) method.invoke(constructor.newInstance());
    ...
    public static Class<?> loadClass(String fullyQualifiedClassName) {
        try {
            return ClassUtils.getClass(fullyQualifiedClassName);
